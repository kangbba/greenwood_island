...
public class ImaginationEnter : Element
{
    ...
    // 생성자: 상상 ID, 지속 시간, 이징 타입을 받아서 초기화
    public ImaginationEnter(string imaginationID, float scaleFactor, float duration = 1f, Ease easeType = Ease.OutQuad)
    {
    ...
    public override IEnumerator ExecuteRoutine()
    {
        ...
        ImaginationManager.FadeInImagination(_imaginationID, _duration, _easeType);
